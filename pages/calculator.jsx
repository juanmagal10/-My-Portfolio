  ...
  return (
    <div className='w-full'>
          <div className='w-screen h-[30vh] lg:h-[40vh] relative'>
              ...
              <Image className='absolute z-1' layout='fill' objectFit='cover' src={calculator} /> 
              ...
              <div className='col-span-4'>
                  ...
                  <p>Movies list made with axios.<br></br> I did that app as an exercice for my request practice. It takes the most viewed movies from an api and displays it in the app.
                    I had to use a key to make the request to the api and was really usefull to me.
                     ...
                     <button className='px-8 py-2 mt-4 mr-8'><Link href="https://jmgcalculator.netlify.app/" passHref>
                    <a target='_blank'>Link</a></Link></button>
                    <button className='px-8 py-2 mt-4'><Link href="https://github.com/juanmagal10/react-calculator/tree/master/calculadora-react" passHref>
