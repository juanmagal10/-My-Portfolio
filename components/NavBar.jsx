    ...
    return (
        ...
        <div  style={{backgroundColor:`${navBg}`}} className={
          ...
          <div className="flex justify-between items-center w-full h-full px-2 2xl:px-16">
              <Link href='/'><a>
              <Image src='/../public/assets/JMG-logo.png' alt='/' width='79' height='79' /></a></Link>
                <div>
          ...
          <div className={nav ? 'md-hidden fixed left-0 top-0 w-full h-screen bg-black/70':''}>
                <div className={
                  ...
                  <div>
                      ...
                      <div className='border-b (false)border-gray-300 my-4'>
                          <p className='w-[85%] nd:w-[90%] py-4'>Let's work together!</p>
                      </div>
                  </div>
